      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg text-text-secondary">
            ...
            financial advisor who can meet you at our offices or anywhere you are in South Africa. Together we make
        ...
        <div className="mt-6 sm:mt-8 grid gap-4 sm:gap-6 md:grid-cols-2">
          <div className="rounded-xl bg-white p-6 sm:p-8 shadow-lg border border-slate-200">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold text-text-primary">Independent Advisor Desk</h3>
                <p className="text-xs sm:text-sm text-text-secondary">Life, risk, and business protection</p>
              </div>
            </div>
          ...
          <div className="rounded-xl bg-white p-6 sm:p-8 shadow-lg border border-slate-200">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-semibold text-text-primary">Estate & Will Clinic</h3>
                <p className="text-xs sm:text-sm text-text-secondary">Keeping your legacy documents current</p>
              </div>
            </div>
            <p className="mt-5 sm:mt-6 text-sm sm:text-base text-text-secondary">
            ...
            <div className="mt-5 sm:mt-6">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full bg-brand-blue px-4 sm:px-5 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-white transition hover:bg-brand-blue-dark"
              >
