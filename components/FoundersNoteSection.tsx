          ...
          <AnimateOnScroll delay="200ms">
            <div>
              ...
              <div className="prose prose-lg max-w-none text-text-secondary space-y-4">
                ...
                <p>
                  Today, whether you're in the bustling streets of Centurion or the quiet towns of the Karoo, we're here to be your trusted partner. We believe that when local businesses thrive, our communities flourish. That's why we serve clients across South Africa—because every entrepreneur deserves access to expert guidance, no matter where they are.
                </p>
