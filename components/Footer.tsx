    ...
    <footer className="bg-surface-dark text-text-on-dark">
      <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1.5">
              ...
              <FooterLink href="/independent-advisor">Independent Advisor</FooterLink>
              <FooterLink href="/estate-will-clinic">Estate & Will Clinic</FooterLink>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-xs text-text-on-dark/75 sm:text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>4 Grit Ave, Zwartkop, Centurion, 0157</span>
              </li>
        ...
        <div className="mt-5 break-words border-t border-slate-700 pt-4 text-center text-xs text-text-on-dark/60">
          <p>© {currentYear} VNR Professional Accountants (Pty) Ltd. All Rights Reserved.</p>
          <p className="mt-2">
