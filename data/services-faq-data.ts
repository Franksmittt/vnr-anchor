export const servicesFaqs = [
  {
    q: "What is the difference between an accountant and a tax consultant?",
  ...
  },
  {
    ...
    a: "<p>SAIPA (The South African Institute of Professional Accountants) is a leading professional accounting body. Our accreditation signifies that our team adheres to the highest standards of professionalism, ethical conduct, and technical competence. It's a mark of trust and quality assurance for our clients.</p>"
  },
  {
    q: "At what stage should I engage VNR's services?",
    a: "<p>The ideal time is as early as possible. For startups, we ensure you are structured correctly from day one. For growing businesses, we provide the strategic financial management needed to scale sustainably. For established enterprises, we focus on optimization, asset protection, and legacy planning. It's never too soon to have a strategic financial partner.</p>"
  },
];