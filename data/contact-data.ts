...
export const faqs = [
    ...
    { q: "Is there parking available?", a: "<p>Yes, there is ample and secure parking available for our clients at our head office in Zwartkop. However, we also offer remote consultations and can meet with clients anywhere in South Africa - distance is no barrier to expert service!</p>" },
];